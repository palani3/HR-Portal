        ...
        <div className="w-full  dark:border md:mt-0  sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          ...
          <form className="space-y-4 md:space-y-6">
            ...
            <div className="flex items-center justify-end">
                <a href="#" className="text-sm font-medium hover:underline text-black hover:text-red-600 dark:text-white">Forget password</a>
            </div>
            <button type="submit" className="w-full text-white bg-blue-500 p-3 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:bg-black dark:bg-white dark:hover:bg-black dark:focus:ring-primary-800">Login</button>
